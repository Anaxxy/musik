module.exports = {
  ...
  Token: process.env.Token || "OTEyOTQ0ODAzODcwODIyNDEw.GIp65l.nX06nPrc7m8XlfyqH0lToW7PVn3FnnC7JrsPUg", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "912944803870822410", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "fQeeCyHNe6RySoviruoVqV9yLTQNPrpK", // Discord Client Secret
  ...
  Presence: {
    ...
    name: "xnxx.com", // The message shown
    type: "WATCHING",
  },
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "d38e6d92c97a41e0838ab1f994b4dd5f", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "16af237bc0d640ecb01c5ad78c01d8fe", // Spotify Client Secret
  },
};
